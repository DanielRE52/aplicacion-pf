            ...
            if ytime == yevent:  #validacion de errores
                ...
                if st.button("Ajustar modelo Cox"):
                    ...
                    with st.expander("Si deseas conocer el detalle del proceso previo, incluyendo la evaluación del modelo con todas las variables, puedes expandir esta sección"):
                        ...
                        st.write("En primera instancia se ajustará el modelo utilizando el conjunto de entrenamiento, y luego se evaluará su desempeño en el conjunto de prueba. Esto permitirá obtener una estimación más realista de la capacidad predictiva del modelo. Para esto se emplean todas las variables de la base.")
