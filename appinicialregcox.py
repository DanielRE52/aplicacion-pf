            ...
            if ytime == yevent:
                ...
                if "xgb_model" in st.session_state:
                    ...
                    if df2.loc[idx, "PERFIL_DE_RIESGO_1"] == 1 & df2.loc[idx, "PERFIL_DE_RIESGO_2"] == 1:
                        ...
                        st.warning("Para estudiantes de estos perfiles de riesgo se sugiere: ")
                        ...
                        st.warning("- Diseñar planes acompañamiento personalizado, como por ejemplo reuniones de seguimiento mensuales, para estudiantes que se encuentran en periodo de prueba o tienen un promedio general acumulado inferior a 3.5.")
                        st.warning("- Diseñar planes de fortalecimiento de conceptos de materias relacionadas y prerrequisitos, ajustados a las necesidades del estudiante.")
                        ...
                        st.warning("Para estudiantes de este perfil de riesgo se sugiere: ")
                        st.warning("- Revisar los temas evaluados en los cortes con bajo desempeño y asignar actividades de refuerzo específicas.")
                        st.warning("- Planeación de monitorias adicionales focalizadas en las falencias grupales que presenten los estudiantes pertenecientes al perfil de riesgo.")
                        st.warning("- Diseñar planes acompañamiento personalizado, como por ejemplo reuniones de seguimiento mensuales, para estudiantes que se encuentran en periodo de prueba o tienen un promedio general acumulado inferior a 3.5.")
                        st.warning("- Diseñar planes de fortalecimiento de conceptos de materias relacionadas y prerrequisitos, ajustados a las necesidades del estudiante.")
                        st.warning("- Evaluar posibles barreras socioeconómicas y remitir al estudiante a rutas de apoyo institucional si es necesario.")
                        st.warning("- Revisar condiciones de adaptación universitaria y orientar al estudiante hacia estrategias de integración académica.")
                        st.warning("- Analizar si existen patrones diferenciales de desempeño causados por la menor edad y promover estrategias de apoyo inclusivas.")
                        ...
                        st.warning("Para estudiantes de estos perfiles de riesgo se sugiere: ")
                        st.warning("- Diseñar planes acompañamiento personalizado, como por ejemplo reuniones de seguimiento mensuales, para estudiantes que se encuentran en periodo de prueba.")
                        st.warning("- Diseñar planes de fortalecimiento de conceptos de materias relacionadas y prerrequisitos ajustados a las necesidades del estudiante.")
                        st.warning("- Realizar seguimiento académico general y proponer tutorías para fortalecer hábitos de estudio y desempeño acumulado.")
                        st.warning("- Analizar la evolución del estudiante durante el semestre y reforzar los momentos donde se evidencia mayor caída.")
                        st.warning("- Evaluar posibles barreras socioeconómicas y remitir al estudiante a rutas de apoyo institucional si es necesario.")
                        ...
                        st.warning("Este estudiante pertenece al Perfil de Riesgo 4, es decir, ha tenido un desempeño académico bajo históricamente,  y tiene condiciones sociodemograficas vulnerables.")
                        st.warning("Para estudiantes de este perfil de riesgo se sugiere: ")
                        st.warning("- Diseñar planes acompañamiento personalizado, como por ejemplo reuniones de seguimiento mensuales, para estudiantes que se encuentran en periodo de prueba.")
                        st.warning("- Diseñar planes de fortalecimiento de conceptos de materias relacionadas y prerrequisitos ajustados a las necesidades del estudiante.")
                        st.warning("- Evaluar posibles barreras socioeconómicas y remitir al estudiante a rutas de apoyo institucional si es necesario.")
                        ...
                        st.warning("Este estudiante pertenece al Perfil de Riesgo 5, es decir, ha tenido un desempeño académico bajo históricamente, y ha tenido un bajo rendimiento en el semestre.")
                        st.warning("Para estudiantes de este perfil de riesgo se sugiere: ")
                        st.warning("- Diseñar planes acompañamiento personalizado, como por ejemplo reuniones de seguimiento mensuales, para estudiantes que se encuentran en periodo de prueba.")
                        st.warning("- Diseñar planes de fortalecimiento de conceptos de materias relacionadas y prerrequisitos ajustados a las necesidades del estudiante.")
                        st.warning("- Realizar seguimiento académico general y proponer tutorías para fortalecer hábitos de estudio y desempeño acumulado.")
